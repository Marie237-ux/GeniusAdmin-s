...
<html lang="en">
  <head>
    ...
    <title>Profile | Avenir - Tailwind CSS Admin Dashboard Template</title>
  ...
  >
            ...
            >
              ...
              >
                ...
                >
                  ...
                  >
                    <div
                      class="w-20 h-20 flex items-center justify-center border border-gray-200 rounded-full bg-blue-600 dark:border-gray-800"
                    >
    ...
    <!-- BEGIN MODAL -->
    <?php include __DIR__ . '/partials/profile/profile-info-modal.php'; ?>
    <?php include __DIR__ . '/partials/profile/profile-address-modal.php'; ?>
    <!-- END MODAL -->
  </body>
</html>
