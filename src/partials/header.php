...
>
  ...
  >
    ...
    >
      ...
      <a href="index.php" class="lg:hidden flex items-center space-x-2">
        <div class="flex h-8 w-8 items-center justify-center rounded-lg bg-blue-600">
          <svg class="h-5 w-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 10V3L4 14h7v7l9-11h-7z" />
          </svg>
        </div>
        <span class="text-lg font-bold text-gray-800 dark:text-white">Avenir</span>
      </a>
    ...
    >
      <div class="2xsm:gap-3 flex items-center gap-2">
        ...
        >
          ...
          >
            ...
            <div class="flex h-auto flex-col items-center justify-center py-8">
              <div class="flex h-16 w-16 items-center justify-center rounded-full bg-gray-100 dark:bg-gray-800">
                <svg class="h-8 w-8 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 17h5l-5 5-5-5h5v-5a7.5 7.5 0 01-15 0V7a7.5 7.5 0 0115 0v10z" />
                </svg>
              </div>
      ...
      >
        ...
        >
          <span class="mr-3 h-11 w-11 flex items-center justify-center rounded-full bg-blue-600">
            <svg class="h-6 w-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
            </svg>
          </span>

          <span class="text-theme-sm mr-1 block font-medium"><?php echo htmlspecialchars($_SESSION['user_name'] ?? 'Utilisateur'); ?></span>
        ...
        >
          <div>
            ...
            >
<?php echo htmlspecialchars($user_name ?? 'Utilisateur'); ?>
            </span>
            <span
              class="text-theme-xs mt-0.5 block text-gray-500 dark:text-gray-400"
            >
<?php echo htmlspecialchars($user_email ?? 'admin@avenir.com'); ?>
            </span>
          </div>
          ...
          <a
            href="/Avenir/src/Auth/logout.php"
